...
<div class="form-container">
	...
	<?php
		...
		echo '<a class="btn-view-pdf"  href="/csv?pid='.$pid.'" >Download CSV</a>';
		echo '<a class="btn-view-pdf"  href="/report/pdf?pid='.$pid.'" target="_blank">View PDF</a>';
...
<script type="text/javascript">
	...
	function initAutoSave() {
		...
		jQuery('form').on('keyup change paste', ':input', function(){
			clearSetInterval();
	...
	function isUserLoggedIn() {		
		let ajaxurl = "<?php echo admin_url('admin-ajax.php'); ?>?action=is_user_logged_in";
